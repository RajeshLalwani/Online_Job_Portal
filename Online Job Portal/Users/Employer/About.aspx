<%@ Page Title="About" Language="C#" MasterPageFile="~/Users/Employer/Employer.Master" AutoEventWireup="true" CodeFile="About.aspx.cs" Inherits="About" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="join-us-cta">
        <div class="container">
            ...
            <asp:Button runat="server" ID="btnJoinNow" Text="Get Started Now" CssClass="btn btn-cta-join" PostBackUrl="~/Users/Employer/Add_New_Job.aspx" />
        </div>
    </div>
