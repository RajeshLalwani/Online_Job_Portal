<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Job_Seeker/Job_Seeker.master" AutoEventWireup="true" CodeFile="FindJobs.aspx.cs" Inherits="Users_Job_Seeker_FindJobs" %>
            ...
            <p class="lead">Search from thousands of active IT job listings from top companies.</p>
             <div class="search-bar-container">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <asp:Button ID="btnSearchMain" runat="server" Text="Search" CssClass="btn btn-search" OnClick="btnSearch_Click" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3">
                <div class="filter-sidebar">
                    ...
                    <div class="filter-buttons">
                        <asp:Button ID="btnApplyFilters" runat="server" Text="Filter" CssClass="btn btn-filter pull-left" OnClick="btnSearch_Click" />
           ...
           <!-- Job Listings -->
            <div class="col-md-9">
                <asp:Repeater ID="rptJobList" runat="server">
                    <ItemTemplate>
                        <asp:HyperLink runat="server" NavigateUrl='<%# "~/Users/Job_Seeker/JobDetails.aspx?id=" + Eval("JobID") %>' CssClass="job-card-link">
                            <div class="job-card">
