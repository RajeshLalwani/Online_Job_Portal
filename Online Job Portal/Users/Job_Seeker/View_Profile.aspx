<%@ Page Title="Personal Profile" Language="C#" MasterPageFile="~/Users/Job_Seeker/Job_Seeker.master" AutoEventWireup="true" CodeFile="View_Profile.aspx.cs" Inherits="Users_Job_Seeker_View_Profile" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        ...
        .profile-picture-large {
            ...
            margin-top: -90px; /* Pulls the image up into the hero space */
            margin-bottom: 15px;
            background-color: #fff;
        }
    ...
    <div class="profile-hero">
        <div class="container">
            ...
            <p class="lead">This is how employers and recruiters will see your profile.</p>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="contact-card">
                    ...
                    <asp:HyperLink ID="hlEditProfile" runat="server" NavigateUrl="~/Users/Job_Seeker/Edit_Profile.aspx" CssClass="btn btn-profile-action" style="background: #eee; color: #333 !important;">
