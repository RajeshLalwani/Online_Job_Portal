<%@ Page Title="" Language="C#" MasterPageFile="~/Users/Guest/Guest.master" AutoEventWireup="true" CodeFile="RegisterSeeker.aspx.cs" Inherits="Account_RegisterSeeker" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <%-- Custom CSS for a beautiful, multi-step registration form --%>
    <style>
        .registration-hero {
        ...
        /* --- DEFINITIVE, FINAL FIX FOR ALL FORM CONTROLS --- */
    ...
    <div class="registration-hero">
        <div class="container">
            ...
            <p class="lead">Join thousands of tech professionals and get discovered by top IT companies.</p>
        </div>
    </div>
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="registration-form-container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtFirstName" runat="server" CssClass="form-control" placeholder="e.g., Jane"></asp:TextBox>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtLastName" runat="server" CssClass="form-control" placeholder="e.g., Doe"></asp:TextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPhoneNumber" runat="server" CssClass="form-control" placeholder="e.g., (123) 456-7890"></asp:TextBox>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtAddress" runat="server" CssClass="form-control" placeholder="123 Main St" TextMode="MultiLine" Rows="3" Style="height: auto;"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <%-- CORRECTED: Changed to DropDownList with IT-specific degrees --%>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtTotalExperience" runat="server" CssClass="form-control" TextMode="Number" placeholder="e.g., 5"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvTotalExperience" runat="server" ControlToValidate="txtTotalExperience" ErrorMessage="Experience is required." CssClass="validation-error" Display="Dynamic" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtSkills" runat="server" CssClass="form-control" placeholder="e.g., C#, ASP.NET, SQL, Azure, React" TextMode="MultiLine" Rows="3" Style="height: auto;"></asp:TextBox>
                        ...
                        <div class="col-md-6 text-center">
                            <div class="form-group">
                                ...
                                <div class="file-upload-wrapper">
                                    ...
                                    <asp:FileUpload ID="fuProfilePicture" runat="server" onchange="previewImage(this);" />
                                </div>
                                ...
                                <div>
                                    <img id="profilePicPreview" src="../images/default-profile.png" alt="Profile Preview" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 text-center">
                            <div class="form-group">
                                ...
                                <div class="file-upload-wrapper">
                                    <span id="resumeBtn" class="file-upload-btn"><span class="glyphicon glyphicon-open-file"></span>Upload your resume...</span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlSecQue" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem>What was your first pet's name?</asp:ListItem>
                    ...
                    <div class="text-center">
                        <asp:Button ID="btnRegister" runat="server" Text="Create My Profile" CssClass="btn btn-register-submit" OnClick="btnRegister_Click" />
                    </div>
